...
import (
	...
	"oskr.nl/arma-horus.go/internal/validator"
)
...
func (app *application) readString(qs url.Values, key string, defaultValue string) string {
	// get value for a given key from query string
...
func (app *application) background(fn func()) {
	app.wg.Add(1)
	go func() {
		defer app.wg.Done() // defer to decrement WaitGroup before goroutine returns
		defer func() {
